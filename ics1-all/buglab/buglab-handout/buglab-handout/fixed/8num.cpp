...
int IDS(int max_depth)
{
    ...
    cout << "enter find_blankTile()" << endl;
    cout << start.zero_x << " " << start.zero_y << endl;
    ...
    while (!que.empty())
    {
        ...
        // cout << "que not empty" << curs.zero_x << " " << curs.zero_y << endl;
        ...
        cout << "11111 curState: " << matrix2string(curState->matrix) << endl;
        if (curState->parent != nullptr)
            cout << "11111 curState_parent: " << matrix2string(curState->parent->matrix) << endl;
        ...
        else
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                ...
                else
                {
                    ...
                    cout << "22222 curState: " << matrix2string(curState->matrix) << endl;
                    if (curState->parent != nullptr)
                        cout << "22222 curState_parent: " << matrix2string(curState->parent->matrix) << endl;

                    cout << "now nextstate_parent" << matrix2string(nextState->parent->matrix) << endl;
                    que.push(std::make_pair(*nextState, nextDepth));
                    cout << "now que.pushin: " << matrix2string(que.top().first.matrix) << endl;
